...
export const TelegramIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <g fill="none">
      ...
      <rect width={256} height={256} fill="#34A7C1" rx={60} />
      <path
        fill="#fff"
        d="M193.365 88.492l-26.062 122.604c-1.685 7.782-6.239 9.723-11.695 6.014l-37.905-26.748-18.251 17.599c-1.874 1.879-3.474 3.564-7.138 3.564l2.637-37.151 70.44-63.544c3.101-2.8-.682-4.332-3.099-1.539l-85.842 61.631-36.733-11.443c-7.621-2.37-7.665-7.611.891-10.662l162.822-60.381c6.786-2.526 12.694.625 10.44 11.321z"
      />
    </g>
  </svg>
);
