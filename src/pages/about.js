          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            >
              ...
              <p className="font-medium ">
                Hey there, I`m Ikboljon. My world revolves around turning
              ...
              <p className="my-4 font-medium">
                ...
                from optimizing trucking logistics with intelligent systems at
                Dontrans LLC to pioneering web applications at Capgemini.
              </p>
              <p className="font-medium">
